...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post scores_url, params: { score: { score: @score.score, userid: @score.userid, username: @score.username } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { score: @score.score, userid: @score.userid, username: @score.username } }
